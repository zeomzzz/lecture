...
character_size = character.get_rect().size # 이미지의 크기를 구해옴. rect : rectangle의 약자
...
enemy_size = enemy.get_rect().size # 이미지의 크기를 구해옴. rect : rectangel의 약자
enemy_width = enemy_size[0] # 캐릭터의 가로 크기
enemy_height = enemy_size[1] # 캐릭터의 세로 크기
enemy_x_pos = (screen_width / 2) - (enemy_width / 2)  # 화면 가로의 절반 크기에 해당하는 곳에 위치하도록 설정 (가로)
